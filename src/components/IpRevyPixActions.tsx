...
const IP_REVY_ACCOUNT_UUID = "130e63e7-c9b7-451d-827e-7b04ef5914f8";
...
export default function IpRevyPixActions() {
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="send" className="w-full">
            ...
            <CardHeader>
              ...
              <CardDescription className="flex items-center gap-2">
                ...
                <Badge variant="outline" className="ml-2">
                  Tenant: OTC (ID: {IP_REVY_TENANT_ID})
                </Badge>
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="keys">
          <PixKeysSection accountId={IP_REVY_ACCOUNT_UUID} tenantLabel="OTC" />
        </TabsContent>
      </Tabs>
    </div>
  );

...
export default function TopBarCorpX() {
  // TODO: Obter CNPJ do contexto de autenticação ou props
  const cnpjDefault = "14283885000198"; // CNPJ de exemplo do guia
  ...
  const getContaInfo = () => {
    return (
      <div className="text-xs text-muted-foreground">
        <span>
          CORPX • BRL • {lastUpdated ? lastUpdated.toLocaleTimeString('pt-BR') : 'Nunca atualizado'}
        </span>
      </div>
    );
  };

...
// Env-driven (X_CORPX_V2_BASE_URL) p/ apontar ao lab; default = prod.
const CORPX_V2_BASE_URL = (import.meta.env.X_CORPX_V2_BASE_URL as string) || 'https://api-bank-v2.gruponexus.com.br';
